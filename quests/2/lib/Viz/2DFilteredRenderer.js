...
export default class FilteredRenderer extends Renderer {
  ...
  resizeCanvas() {
    ...
    // Adjust scaling for the aspect ratio
    this._scaleX = aspectRatio;
    this._scaleY = 1.0;
