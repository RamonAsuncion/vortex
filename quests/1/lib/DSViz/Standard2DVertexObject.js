  ...
  async createGeometry() {
    ...
    this._vertexBufferLayout = {
      ...
      attributes: [
        ...
        {
          shaderLocation: 1, // color in the vertex shader
          format: "float32x4", // four floats for r, g, b, a
          offset: 2 * Float32Array.BYTES_PER_ELEMENT, // skip the first two positions (two floats).
        },
      ],
    };
  }
