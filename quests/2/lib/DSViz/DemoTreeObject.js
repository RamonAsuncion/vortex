...
export default class DemoTreeObject extends Standard2DPGAPosedVertexColorObject {
  constructor(device, canvasFormat, pose) {
    let _vertices = new Float32Array([
      ...
      110.0 / 255,
      34.0 / 255,
      1, // A triangle for a layer of the Xmas tree
      -0.1,
      -0.15,
      34.0 / 255,
      90.0 / 255,
  ...
  updateGeometry() {
    ...
    this._pose[0] =
      this._pose0[0] * (1 - this._t / this._interval) +
      (this._pose1[0] * this._t) / this._interval;
    this._pose[1] =
      this._pose0[1] * (1 - this._t / this._interval) +
      (this._pose1[1] * this._t) / this._interval;
    this._pose[2] =
      this._pose0[2] * (1 - this._t / this._interval) +
      (this._pose1[2] * this._t) / this._interval;
    this._pose[3] =
      this._pose0[3] * (1 - this._t / this._interval) +
      (this._pose1[3] * this._t) / this._interval;
